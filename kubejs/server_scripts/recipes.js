...
// Splashing
	...
	event.recipes.create.splashing(['9x oreganized:lead_nugget', Item.of('kubejs:rough_quartz_shard', 3).withChance(0.5)], 'create:crushed_raw_lead').id('oreganized:create/splashing/crushed_lead_ore')
