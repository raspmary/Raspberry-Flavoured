...
// Items
	...
	event.create('feldspar')
	event.create('pulp')
	event.create('bone_powder')
	...
	event.create('bait_can').maxStackSize(16).rarity('uncommon')
	event.create('loot_bag').maxStackSize(16).rarity('uncommon')
	event.create('witch_bag').maxStackSize(16).rarity('uncommon')
	event.create('herb_bag').maxStackSize(16).rarity('uncommon')
...
// Food & drinks
	...
	event.create('marshmallows_with_jam').food(food => {
		food
    		.hunger(6)
    		.saturation(0.3)
	...
	// Bottle
	event.create('cactus_juice').containerItem('minecraft:glass_bottle').food(food => {
		food
		...
		.useAnimation("drink")
	event.create('avocado_lemon_smoothie').containerItem('minecraft:glass_bottle').food(food => {
		food
    		.hunger(3)
			.saturation(0.8)
