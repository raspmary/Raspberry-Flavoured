...
StartupEvents.registry('block', event => {
	...
	event.create('button_mushroom_basket').soundType('wood').hardness(1.5).resistance(1.5)
	event.create('crimini_basket').soundType('wood').hardness(1.5).resistance(1.5)
	event.create('portabella_basket').soundType('wood').hardness(1.5).resistance(1.5)
	event.create('milly_bubcap_basket').soundType('wood').hardness(1.5).resistance(1.5)
	event.create('crimson_fungus_basket').soundType('wood').hardness(1.5).resistance(1.5)
	event.create('warped_fungus_basket').soundType('wood').hardness(1.5).resistance(1.5)
	event.create('choral_fungus_basket').soundType('wood').hardness(1.5).resistance(1.5)
	
	event.create('worm_crate').soundType('wood').hardness(1.5).resistance(1.5)
	event.create('golden_worm_crate').soundType('wood').hardness(1.5).resistance(1.5)
	event.create('grub_crate').soundType('wood').hardness(1.5).resistance(1.5)
	...
	event.create('diamond_plating_block').soundType('metal').hardness(5).resistance(12).requiresTool(true)
	event.create('diamond_plating_stairs', 'stairs').soundType('metal').hardness(5).resistance(12).requiresTool(true)
	event.create('diamond_plating_slab', 'slab').soundType('metal').hardness(5).resistance(12).requiresTool(true)
	...
	event.create('oraclestone').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('oraclestone_slab', 'slab').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('oraclestone_stairs', 'stairs').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('oraclestone_wall', 'wall').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	
	event.create('celestone').soundType('basalt').hardness(1.25).resistance(4.2).requiresTool(true)
	
	event.create('feldspar_block').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('feldspar_slab', 'slab').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('feldspar_stairs', 'stairs').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('feldspar_wall', 'wall').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	
	event.create('polished_feldspar').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('polished_feldspar_slab', 'slab').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('polished_feldspar_stairs', 'stairs').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('polished_feldspar_wall', 'wall').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	
	event.create('feldspar_bricks').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('feldspar_brick_slab', 'slab').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('feldspar_brick_stairs', 'stairs').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	event.create('feldspar_brick_wall', 'wall').soundType('stone').hardness(1.5).resistance(6).requiresTool(true)
	
	event.create('lachryte').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('lachryte_slab', 'slab').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('lachryte_stairs', 'stairs').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('lachryte_wall', 'wall').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	
	event.create('polished_lachryte').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('polished_lachryte_slab', 'slab').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('polished_lachryte_stairs', 'stairs').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('polished_lachryte_wall', 'wall').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	
	event.create('lachryte_bricks').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('lachryte_brick_slab', 'slab').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('lachryte_brick_stairs', 'stairs').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	event.create('lachryte_brick_wall', 'wall').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	
	event.create('chiseled_lachryte').soundType('shroomlight').hardness(1.5).resistance(6).requiresTool(true)
	
	event.create('enigmatic_tile_slab', 'slab').soundType('stone').hardness(8).resistance(600).requiresTool(true)
	event.create('enigmatic_tile_stairs', 'stairs').soundType('stone').hardness(8).resistance(600).requiresTool(true)
	event.create('enigmatic_tile_wall', 'wall').soundType('stone').hardness(8).resistance(600).requiresTool(true)
	
	event.create('polished_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_sandstone_slab', 'slab').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_sandstone_stairs', 'stairs').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_sandstone_wall', 'wall').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('polished_red_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_red_sandstone_slab', 'slab').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_red_sandstone_stairs', 'stairs').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_red_sandstone_wall', 'wall').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('polished_soul_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_soul_sandstone_slab', 'slab').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_soul_sandstone_stairs', 'stairs').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('polished_soul_sandstone_wall', 'wall').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('sandstone_tiles').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('sandstone_tile_slab', 'slab').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('sandstone_tile_stairs', 'stairs').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('sandstone_tile_wall', 'wall').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('red_sandstone_tiles').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('red_sandstone_tile_slab', 'slab').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('red_sandstone_tile_stairs', 'stairs').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('red_sandstone_tile_wall', 'wall').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('soul_sandstone_tiles').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('soul_sandstone_tile_slab', 'slab').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('soul_sandstone_tile_stairs', 'stairs').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('soul_sandstone_tile_wall', 'wall').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('cracked_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('cracked_red_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('cracked_soul_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('cracked_layered_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('cracked_layered_red_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('cracked_layered_soul_sandstone').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('cracked_sandstone_bricks').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('cracked_red_sandstone_bricks').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	event.create('cracked_soul_sandstone_bricks').soundType('stone').hardness(0.8).resistance(0.8).requiresTool(true)
	
	event.create('sandstone_pillar')
    .soundType('stone')
	...
	event.create('red_sandstone_pillar')
    .soundType('stone')
    .hardness(0.8).resistance(0.8)
    .property(BlockProperties.AXIS)
    .placementState(event => event.set(BlockProperties.AXIS, event.clickedFace.axis))
    .model('kubejs:block/red_sandstone_pillar')
	event.create('soul_sandstone_pillar')
    .soundType('stone')
    .hardness(0.8).resistance(0.8)
    .property(BlockProperties.AXIS)
    .placementState(event => event.set(BlockProperties.AXIS, event.clickedFace.axis))
	...
	event.create('withered_bone_pile')
    .soundType('bone_block')
    .hardness(1).resistance(1)
    .property(BlockProperties.AXIS)
    .placementState(event => event.set(BlockProperties.AXIS, event.clickedFace.axis))
