...
// pickerelweed
  tooltip.addAdvanced('upgrade_aquatic:boiled_purple_pickerelweed', (item, advanced, text) => {
      text.add(1, [Text.translate("rf.tooltip.oxygen_restore").blue()])
  })
  
// oracle jelly
  tooltip.addAdvanced('minecraft:chorus_fruit', (item, advanced, text) => {
      text.add(1, [Text.translate("rf.tooltip.random_teleport").blue()])
  })
...
// foul fernet
  tooltip.addAdvanced('kubejs:foul_fernet', (item, advanced, text) => {
      ...
      text.add(3, [Text.translate("rf.tooltip.extinguishes_fire").blue()])
  })
