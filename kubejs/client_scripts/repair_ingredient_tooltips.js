...
ItemEvents.tooltip(event => {
    ...
    'alloyed:steel_shears': 'item.minecraft.diamond',
    ...
    'quark:trowel': 'item.additionaladditions.rose_gold_alloy',
    ...
    'modestmining:wooden_javelin': 'item.minecraft.flint',
    'modestmining:stone_javelin': 'item.minecraft.bone, item.architects_palette.withered_bone, item.aquaculture.fish_bones',
    ...
    'oreganized:electrum_sword': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
    'oreganized:electrum_shovel': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
    'oreganized:electrum_pickaxe': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
    'oreganized:electrum_axe': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
    'oreganized:electrum_hoe': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
    'oreganized:electrum_knife': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
	
    'oreganized:electrum_helmet': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
    'oreganized:electrum_chestplate': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
    'oreganized:electrum_leggings': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
    'oreganized:electrum_boots': 'item.oreganized.electrum_ingot, item.modestmining.diamond_plating',
	
    'caverns_and_chasms:necromium_sword': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
    'caverns_and_chasms:necromium_shovel': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
    'caverns_and_chasms:necromium_pickaxe': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
    'caverns_and_chasms:necromium_axe': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
    'caverns_and_chasms:necromium_hoe': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
    'abnormals_delight:necromium_knife': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
	
    'caverns_and_chasms:necromium_helmet': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
    'caverns_and_chasms:necromium_chestplate': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
    'caverns_and_chasms:necromium_leggings': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
    'caverns_and_chasms:necromium_boots': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
	
    'minecraft:netherite_sword': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    'minecraft:netherite_shovel': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    'minecraft:netherite_pickaxe': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    'minecraft:netherite_axe': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    'minecraft:netherite_hoe': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    'farmersdelight:netherite_knife': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
	
    'minecraft:netherite_helmet': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    'minecraft:netherite_chestplate': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    'minecraft:netherite_leggings': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    'minecraft:netherite_boots': 'item.minecraft.netherite_ingot, item.modestmining.diamond_plating',
    ...
    'clash:greatblade': 'item.caverns_and_chasms.necromium_ingot, item.modestmining.diamond_plating',
